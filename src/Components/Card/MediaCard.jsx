...
const MediaCard = ({ setTotal, total, sq, setSq }) => {
  ...
  const addSq = () => {
    setSq((prevTotal) => prevTotal + value);
    localStorage.setItem("sq", sq + value);
  };
  useEffect(() => {
    ...
    <div className="lg:flex justify-between  mt-5">
      ...
      <div className="card rounded-lg w-80 bg-base-100 shadow-lg lg:h-[150px]">
        <div className="card-body  justify-center items-center">
          ...
          <p className="text-lg font-medium  pt-5">{sq} SQ Feet</p>
        </div>
      </div>
    </div>
  );
